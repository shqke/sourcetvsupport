...
SMExtension *g_Extension = &g_Plugin;
...
bool MMSPlugin::LoadSMExtension(char *error, int maxlength)
{
	...
	if (smexts->LoadExternal(static_cast<IExtensionInterface *>(this), "addons" PLATFORM_SEP "sourcetvsupport." PLATFORM_LIB_EXT, "sourcetvsupport." PLATFORM_LIB_EXT, error, maxlength) == NULL) {
		SMExtension::Unload();
